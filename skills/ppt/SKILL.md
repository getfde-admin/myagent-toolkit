...
```sh
node .agents/skills/ppt/scripts/build.js <input.md|input.json> [options]
```
...
```sh
# 基本：產生 deck.pptx
node .agents/skills/ppt/scripts/build.js artifacts/123/deck.md --out artifacts/123/deck.pptx

# 深色主題、4:3
node .agents/skills/ppt/scripts/build.js deck.md --theme dark --layout 4x3

# 從 stdin 讀
cat deck.md | node .agents/skills/ppt/scripts/build.js -
```
...
```sh
cd skills/ppt && bun install && bun run build
```
